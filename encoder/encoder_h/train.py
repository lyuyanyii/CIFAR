...
if __name__ == '__main__':
	...
	with TrainingEnv(name = "lyy.{}.test".format(net_name), part_count = 2, custom_parser = parser) as env:
		...
		net.loss_var = WeightDecay(net.loss_var, {"*encoder*":1e-4, "*outputs*":1e-4})
		"""
		...
		lr = 0.0004
		optimizer = megskull.optimizer.AdamV8(lr, 0.9, 0.999)
